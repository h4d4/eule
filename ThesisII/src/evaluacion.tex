...
implícitos. La tabla \ref{tb:comparacion} ilustra los resultados.\newline
INCLUIR TABLAS: una con todos los resultados de evalución para las tres
herramientas, otra con la cantidad de falsos positos de cada una.\newline
...
por tanto, el Prototipo detecta mayor cantidad fugas existentes (verdaderos
positivos(TP)). Para este caso particular, el Prototipo detecta todos los
TP.\newline
