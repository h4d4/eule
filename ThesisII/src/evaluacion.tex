...
\textbf{Martín: esta parte debería ir en esta sección, o en la discusión?}\newline
 Dentro de las limitaciones técnicas \ref{sec:limitaciones} descritas en el
 diseño de la solución propuesta para generar la versión Jif del programa
 Android a analizar, se describieron una serie de limitaciones. Para algunas de
 tales limitaciones se propuso un mécanismo que permita soportarlas, estas son:
\begin{itemize}
...
requieran\ref{subsec:consVerPol}. Ahora, para soportar tales limitaciones y
...
adicionar las runtime exceptions que su programa necesite, segundo debe usar
bucles for en vez de Enhanced for loop.\newline
Durante la anotación, además de aplicar los criterios de anotación definidos en
el diseño de la solución \ref{subsec:pasosSol}, se aplican las soluciones
propuestas para soportar el Statement @Override, Casting entre tipos EditText y
...
de dato String; finalmente para la clase nested R, el ajuste al código consiste
en crear una clase que en vez de definir los recursos utilizados por la
aplicación mediante clases, los define a través de variables.\newline 
Solventar tales limitaciones implica ajustes en el código fuente del programa a
analizar, que si bien no cambian la lógica del programa si implican ajustes en
