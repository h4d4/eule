...
criterios definidos, la marca puede ser propagada a causa de flujos explícitos o
de flujos implícitos. En flujos explícitos la propagación ocurre cuando el
valor de una variable marcada está implicada en el calculo de otra varibale. En
flujos implícitos la propagación tiene lugar a través de dependencias en el
control de flujo del programa, por ejemplo, cuando el valor de un dato marcado
afecta indirectamente otra varible.\newline
En el caso de FlowDroid el análisis se concentra en el marcado de flujo de
datos, esto significa que la herramienta está en capacidad de detectar flujos
explicitos, pero no flujos implicítos generados a través del flujo de control
del programa.
