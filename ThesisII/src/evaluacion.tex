...
tainting análisis. Dependiendo de los criterios definidos para propagar el
marcado de datos, el análisis mediante tainting puede enfocarse en el marcado de
flujo de datos o en el marcado de control de flujo, o en ambos. En el caso de
FlowDroid el análisis se concentra en el marcado de flujo de datos, esto
significa que la herramienta está en capacidad de detectar flujos explicitos,
pero no flujos implicítos generados a través del flujo de control del
programa.xx
