...
tabla\ref{tb:comparacion}. En esta, por cada caso de prueba se indica la
cantidad de leaks que presenta, el resultado de análisis devuelto por
la respectiva herramienta, y el tiempo que tarda el análisis mediante una u otra
herramienta.
...
\begin{table}[H]
\small\addtolength{\tabcolsep}{-3pt}
\caption{XXXXX-Comparación Precisión entre FlowDroid y Prototipo. Los campos tF
y tP, describen el tiempo que tarda Flowdroid y el Prototipo(respectivamente) en
...
\cline{1-3}
\multicolumn{0}{ |c|  }{\multirow{0}{*}{FP} }  & 2 & 3 &  \\ \cline{0-2}
\multicolumn{0}{ |c|  }{\multirow{0}{*}{FN} }  & 3 & 0 &  \\ \cline{0-2}
\multicolumn{0}{ |c|  }{\multirow{0}{*}{TP} }  & 12 & 2 &  \\ \cline{0-2}
