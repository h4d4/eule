...
${JIFC} -d sig-classes -sourcepath sig-src sig-src/java/io/*.jif;
${JIFC} -d sig-classes -sourcepath sig-src sig-src/java/lang/*.jif;
${JIFC} -d sig-classes -sourcepath sig-src sig-src/java/math/*.jif;
${JIFC} -d sig-classes -sourcepath sig-src sig-src/java/net/*.jif;
${JIFC} -d sig-classes -sourcepath sig-src sig-src/java/sql/*.jif;
